...
#ifndef _BACK_ENTER_EFFECT_HPP_
#define _BACK_ENTER_EFFECT_HPP_
 ...
 */
class BackEnterEffect : public Effect
{
public:
	/**
	 * Constructor de la clase
	 */
	BackEnterEffect(void);

	/**
	 * Destructor de la clase
	 */
	virtual ~BackEnterEffect(void);
