...
#ifndef _ROTATE_IN_EFFECT_HPP_
#define _ROTATE_IN_EFFECT_HPP_
...
/**
 * Efecto rotación de entrada en escena
 *
 * Realiza un efecto de rotación para entrar en escena mediante la modificación
 * de la rotación y escala, usando para ello la ecuación Exponential de Robert
 * Penner.
 */
class RotateInEffect : public Effect
{
public:
	/**
	 ...
	 */
	RotateInEffect(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~RotateInEffect(void);
