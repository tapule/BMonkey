...
#ifndef _EASE_IN_ANIMATION_HPP_
#define _EASE_IN_ANIMATION_HPP_
...
public:
	 ...
	 */
	EaseInAnimation(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~EaseInAnimation(void);
