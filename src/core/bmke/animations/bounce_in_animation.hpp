...
#ifndef _BOUNCE_IN_ANIMATION_HPP_
#define _BOUNCE_IN_ANIMATION_HPP_
...
/**
 * Animación de entrada en escena usando la ecuación Bounce
 *
...
public:
	 ...
	 */
	BounceInAnimation(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~BounceInAnimation(void);
...
#endif // _BOUNCE_IN_ANIMATION_HPP_
