...
#ifndef _ROLL_IN_ANIMATION_HPP_
#define _ROLL_IN_ANIMATION_HPP_
...
/**
 * Animación roll de entrada en escena
 *
 * Realiza una animación de rotación y escala de la entidad, para entrar en
 * escena, usando para ello la ecuación del efecto easeOutBack.
 */
class RollInAnimation : public Animation
{
public:
	/**
	 ...
	 */
	RollInAnimation(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~RollInAnimation(void);
