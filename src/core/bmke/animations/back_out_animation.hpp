...
#ifndef _BACK_OUT_ANIMATION_HPP_
#define _BACK_OUT_ANIMATION_HPP_
...
/**
 * Animación de salida de escena usando la ecuación Back
 *
 * Realiza una animación de salida de escena mediante la modificación de la
 * posición de la entidad usando para ello la ecuación del efecto especial Back.
 * La animación se puede configurar para finalizar en la izquierda, derecha,
 * arriba o abajo de una ventana indicada.
 */
class BackOutAnimation : public MoveOutAnimation
{
public:
	/**
	 ...
	 */
	BackOutAnimation(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~BackOutAnimation(void);
...
#endif // _BACK_OUT_ANIMATION_HPP_
