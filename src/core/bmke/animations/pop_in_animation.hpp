...
#ifndef _POP_IN_ANIMATION_HPP_
#define _POP_IN_ANIMATION_HPP_
...
/**
 * Animación pop de entrada en escena
 *
 * Realiza una animación pop de entrada en escena mediante la modificación de la
 * escala de la entidad, usando para ello la ecuación del efecto Bounce de
 * Robert Penner.
 */
class PopInAnimation : public Animation
{
public:
	/**
	 ...
	 */
	PopInAnimation(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~PopInAnimation(void);
