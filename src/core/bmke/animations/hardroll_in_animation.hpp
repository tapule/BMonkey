...
#ifndef _HARDROLL_IN_ANIMATION_HPP_
#define _HARDROLL_IN_ANIMATION_HPP_
...
/**
 * Animación roll fuerte de entrada en escena
 *
 * Realiza una animación de rotación y escala de la entidad para entrar en
 * escena usando para ello la ecuación del efecto easeOutElastic.
 */
class HardrollInAnimation : public Animation
{
public:
	/**
	 ...
	 */
	HardrollInAnimation(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~HardrollInAnimation(void);
...
#endif // _HARDROLL_IN_ANIMATION_HPP_
