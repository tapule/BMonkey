...
#ifndef _FADE_IN_ANIMATION_HPP_
#define _FADE_IN_ANIMATION_HPP_
...
/**
 * Animación fade de entrada en escena
 *
 * Realiza una animación fade de entrada en escena mediante la modificación de
 * la opacidad de la entidad, usando para ello la ecuación del efecto Quad de
 * Robert Penner.
 */
...
public:
	 ...
	 */
	FadeInAnimation(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~FadeInAnimation(void);
...
private:
	...
	CDBTweener::CTween* m_tween;	/**< Tweener usado para e la animación */
