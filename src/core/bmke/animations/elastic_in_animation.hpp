...
#ifndef _ELASTIC_IN_ANIMATION_HPP_
#define _ELASTIC_IN_ANIMATION_HPP_
...
/**
 * Animación de entrada en escena usando la ecuación Elastic
 *
 * Realiza una animación de entrada en escena mediante la modificación de la
 * posición de la entidad, usando para ello la ecuación del efecto especial
 * Elastic de Robert Penner.
 * La animación se puede configurar para comenzar desde la izquierda, derecha,
 * arriba o abajo de una ventana indicada.
 */
class ElasticInAnimation : public MoveInAnimation
{
public:
	/**
	 ...
	 */
	ElasticInAnimation(const float delay, const float duration);

	/**
	 * Destructor de la clase
	 */
	virtual ~ElasticInAnimation(void);
...
#endif // _ELASTIC_IN_ANIMATION_HPP_
