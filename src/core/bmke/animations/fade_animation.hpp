...
#ifndef _FADE_ANIMATION_HPP_
#define _FADE_ANIMATION_HPP_
 ...
 * Animación fade
 *
 * Realiza una animación fade contínua mediante la modificación de la opacidad
 * de la entidad. En esencia es un fade in seguido de un fade out repetido
 * constantemente. Usa la ecuación lineal.
 */
...
public:
	 ...
	 */
	FadeAnimation(const float delay, const float duration);
