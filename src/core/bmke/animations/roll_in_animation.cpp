...
#include "roll_in_animation.hpp"
#include <cassert>
#include "../entity.hpp"

namespace bmonkey{

RollInAnimation::RollInAnimation(const float delay, const float duration):
...
void RollInAnimation::stop(void)
{
	m_finished = true;
...
void RollInAnimation::update(sf::Time delta_time)
{
