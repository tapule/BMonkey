...
#include "ease_in_animation.hpp"
#include <cassert>
#include "../entity.hpp"

namespace bmonkey{

EaseInAnimation::EaseInAnimation(const float delay, const float duration):
...
EaseInAnimation::~EaseInAnimation(void)
{
...
void EaseInAnimation::update(sf::Time delta_time)
{
